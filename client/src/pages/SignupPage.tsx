    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center py-16 px-4">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 w-full max-w-sm">
          <h1 className="text-2xl font-bold text-[#3a485b] mb-2">Sign Up</h1>
          <p className="text-sm text-gray-500 mb-6">Create your Remedy508 account.</p>
          ...
          <p className="text-xs text-gray-400 text-center mt-4">
            ...
            <Link href="/login"><span className="text-[#0d9488] hover:underline cursor-pointer">Log in</span></Link>
          </p>
        </div>
      </div>
      <SiteFooter />
