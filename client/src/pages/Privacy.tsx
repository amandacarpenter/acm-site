      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
          ...
          <Section title="1. Information We Collect">
            ...
            <Sub title="Usage and Analytics Data">We use Google Analytics 4 to collect information about how the Service is used, including pages visited, session activity, browser type, device type, and approximate country-level location. Separately, our first-party analytics records an anonymous, hashed browser identifier after a visitor keeps a page visible for at least three seconds and scrolls, taps, clicks, or types. This helps us estimate likely human visitors without collecting a name, email address, document content, or the original identifier. We exclude the admin area, local development, and recognized automated QA sessions from analytics collection. First-party visitor records are retained for up to 90 days.</Sub>
          </Section>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  ["Anonymous engaged-visitor identifier (r508_visitor)", "Remedy508", "Creates a first-party anonymous identifier used to count likely human visitors separately from GA4 after meaningful page interaction. The identifier is hashed before storage and retained for up to 90 days."],
