        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <Section title="4. Subscription Plans and Billing">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 mb-4 space-y-3">
              <div>
                <p className="font-semibold text-[#3a485b]">Individual — $19/month or $199/year</p>
                <p className="text-sm">130 Credits per month, shared across all available tools: Remedy Docs costs 1 Credit per page processed (documents over 50 pages must be split), Remedy Image costs 1 Credit per image, Remedy Video costs 1 Credit per transcript, and Remedy HTML costs 3 Credits per fix. Remedy Layout is marked Coming Soon and is planned to cost 1 Credit per page when it becomes available. Licensed for single-user personal use only. Individual accounts may not be shared.</p>
              </div>
              <div>
                <p className="font-semibold text-[#3a485b]">Team — $249/seat/year (annual only, 2+ seats)</p>
                <p className="text-sm">145 Credits/seat/month — each seat receives its own allotment, not a shared pool — across all available tools: Remedy Docs costs 1 Credit per page processed (documents over 50 pages must be split), Remedy Image costs 1 Credit per image, Remedy Video costs 1 Credit per transcript, and Remedy HTML costs 3 Credits per fix. Remedy Layout is marked Coming Soon and is planned to cost 1 Credit per page when it becomes available. Team plans are licensed for use by one institution or organization. Reselling or sublicensing access is prohibited. Pay by credit card or invoice/PO, available at Remedy508’s discretion.</p>
              </div>
            </div>
