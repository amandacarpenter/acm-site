      ...
      <section className="py-16 bg-[#3a485b]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            Remedy508 is operated by <span className="text-white font-semibold">Left Coast Learning LLC</span>, a California company focused on building practical accessibility tools for higher education.
          </p>
        </div>
      </section>
