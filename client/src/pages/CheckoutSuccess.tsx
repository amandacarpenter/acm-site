  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="flex flex-col items-center justify-center py-32 px-4 text-center">
        <CheckCircle2 className="w-16 h-16 text-[#0f766e] mb-6" aria-hidden="true" />
        ...
        <Link href="/dashboard">
          <span className="inline-flex items-center justify-center px-8 py-3 rounded-xl font-semibold text-base bg-[#0f766e] text-white hover:bg-[#115e59] transition cursor-pointer">
            Go to Dashboard
          </span>
        </Link>
      </main>
